...
style: |
  ...
  .sc-line.blue { background: #bfdbfe; }
  ...
  .sc-col.b1 { background: #dbeafe; }
  .sc-col.b2 { background: #eff6ff; }
  .sc-col.b3 { background: #e5e7eb; }
  ...
  .sc-pill.blue { background: #2563eb; opacity: 0.5; }
  .sc-pill.gray { background: #d1d5db; }
