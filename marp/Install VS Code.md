...
<div class="tools">
  ...
  <div class="tool-card">
    ...
    <div class="desc">Run commands without leaving the editor. Your code and terminal, side by side.</div>
  </div>
</div>
...
<ul class="step-list">
  <li>Go to <strong>code.visualstudio.com</strong> — the big blue Download button auto-detects Mac.</li>
  <li>Open the downloaded <code>.zip</code> file. It extracts to <strong>Visual Studio Code.app</strong>.</li>
  <li>Drag <strong>Visual Studio Code.app</strong> into your <code>/Applications</code> folder. Don't skip this — running it from Downloads causes issues.</li>
  <li>Open VS Code. If macOS says "unverified developer," go to <strong>System Settings → Privacy & Security</strong> and click Open Anyway.</li>
</ul>

<div class="highlight">

**First launch tip:** VS Code will ask to install the `code` command in PATH. Click **Install** — this lets you open any folder from Terminal with `code .`
...
Open the Extensions panel with `⌘ Shift X`, then search by name.
...
<div class="two-col">
  <div class="col-card">
    ...
    <p style="font-size:14px; margin-top:8px;">Press <code>⌘ K</code> then <code>⌘ T</code> to open the theme picker. Arrow keys preview in real time.</p>
  </div>
  <div class="col-card">
    <div class="label">Or via Command Palette</div>
    <p style="font-size:14px; margin-top:8px;">Press <code>⌘ Shift P</code>, type <code>color theme</code>, hit Enter.</p>
  </div>
</div>
...
<div class="two-col">
  ...
  <div class="col-card">
    ...
    <p style="font-size:14px; margin-top:8px;">Press <code>⌘ ,</code> to open Settings. Search <code>autosave</code>. Set to <strong>afterDelay</strong> (1000ms default).</p>
  </div>
</div>
