...
Plus CAROUSELS/ for social derivatives and PI-CODING-AGENT/ for the Pi tutorial package.
Tracks ZERO TO AI BUILDER + CLAUDE CODE are solid; PROMPT ENGINEERING + VIBE CODING 101
are stubs. PI-CODING-AGENT now has separate concise/expanded Marp decks and a canonical
long-form source for its vertical PDF.
