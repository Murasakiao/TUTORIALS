...
style: |
  ...
  section::after{font-family:'DM Mono',monospace;font-size:9px;color:var(--muted);letter-spacing:1px;content:'CLAUDE CODE · /context · ' attr(data-marpit-pagination) ' / ' attr(data-marpit-pagination-total);position:absolute;bottom:20px;right:40px;}
---

<!-- _class: cover -->

<div class="tag">Claude Code · Command 03</div>

# `/context`

See exactly where your tokens are going.

*The diagnostic you run before /compact.*

---

<div class="header-row">
  <span class="page-num">— what it is —</span>
  <span class="page-label">a window into your window</span>
</div>

## What `/context` shows you

Displays a colored grid visualization of your current context window usage — broken down by what's consuming the most space. Flags problems before they start affecting Claude's quality.

<div class="cards-col">
  <div class="card-row">
    <span class="card-row-icon">🟩</span>
    <div class="card-row-body">
      <h3>Colored usage grid</h3>
      <p>Each block represents a segment of your context. Color shifts from green → yellow → red as usage grows.</p>
    </div>
  </div>
  <div class="card-row">
    <span class="card-row-icon">📊</span>
    <div class="card-row-body">
      ...
      <p>Shows how much space conversation history, tool outputs, file reads, and memory files are each consuming.</p>
    </div>
  </div>
  <div class="card-row">
    <span class="card-row-icon">💡</span>
    <div class="card-row-body">
      ...
      <p>Flags context-heavy tools, memory bloat, and capacity warnings — with specific suggestions on what to fix.</p>
    </div>
  </div>
</div>
...
<div class="header-row">
  ...
  <span class="page-label">what to look for</span>
</div>
...
<div class="cards">
  <div class="card">
    ...
    <h3>Red blocks = danger zone</h3>
    <p>You're close to the limit. Run <code>/compact</code> with a focus instruction before the next heavy task.</p>
  </div>
  <div class="card">
    <span class="card-icon">🔧</span>
    <h3>Tool outputs bloating</h3>
    <p>Bash commands and file reads are often the culprit. The hint tells you which tools are using the most space.</p>
  </div>
  <div class="card">
    <span class="card-icon">📁</span>
    <h3>Memory file bloat</h3>
    <p>If CLAUDE.md or auto-memory is large, the hint flags it. Use <code>/memory</code> to trim outdated entries.</p>
  </div>
  <div class="card">
    <span class="card-icon">💬</span>
    <h3>Conversation history</h3>
    <p>Long back-and-forth grows fast. If this is the culprit, compact with a focus on the current task state.</p>
  </div>
</div>
...
<div class="header-row">
  ...
  <span class="page-label">the diagnostic habit</span>
</div>
...
<div class="list">
  <div class="list-item">
    ...
    <span class="list-text"><strong>Before running /compact</strong> — understand why the context is full before summarizing it</span>
  </div>
  <div class="list-item">
    <span class="list-num">✅</span>
    <span class="list-text"><strong>When Claude starts giving shorter or vaguer answers</strong> — context pressure is often the cause</span>
  </div>
  <div class="list-item">
    <span class="list-num">✅</span>
    <span class="list-text"><strong>After a long file-reading session</strong> — tool outputs stack up invisibly; check before the next big task</span>
  </div>
  <div class="list-item">
    <span class="list-num">✅</span>
    <span class="list-text"><strong>Periodically in long sessions</strong> — treat it like a fuel gauge; glance at it every 20–30 turns</span>
  </div>
</div>
...
<div class="header-row">
  ...
  <span class="page-label">use it in a workflow</span>
</div>
...
<div class="cards">
  <div class="card">
    ...
    <h3>Check with /context</h3>
    <p>See what's filling the window and where the pressure is coming from.</p>
  </div>
  <div class="card">
    <span class="card-icon">2️⃣</span>
    <h3>Trim with /memory</h3>
    <p>If CLAUDE.md is bloated, edit it down before compacting. Less in = more room out.</p>
  </div>
  <div class="card">
    <span class="card-icon">3️⃣</span>
    <h3>Compress with /compact</h3>
    <p>Now compact intelligently, knowing exactly which thread to preserve in the focus instruction.</p>
  </div>
  <div class="card">
    <span class="card-icon">4️⃣</span>
    <h3>Re-check to confirm</h3>
    <p>Run <code>/context</code> again after compacting to confirm the window has opened up as expected.</p>
  </div>
</div>
...
<div class="tag" style="justify-content:center;color:#0a0a0a;margin-bottom:20px;">Claude Code · /context</div>

# Know before<br>you compact.

## /context first. /compact second.

<p>Blind compacting loses important context. Seeing the breakdown first means you compact with precision.</p>
